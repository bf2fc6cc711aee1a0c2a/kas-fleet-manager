...
// GetSupportedSizesOpts Optional parameters for the method 'GetSupportedSizes'
type GetSupportedSizesOpts struct {
	Page optional.String
	Size optional.String
}

/*
GetSupportedSizes Returns the list of supported Kafka instance profiles and sizes
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetSupportedSizesOpts - Optional Parameters:
 * @param "Page" (optional.String) -  Page index
 * @param "Size" (optional.String) -  Number of items in each page
@return SupportedKafkaProfileList
*/
func (a *DefaultApiService) GetSupportedSizes(ctx _context.Context, localVarOptionals *GetSupportedSizesOpts) (SupportedKafkaProfileList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  SupportedKafkaProfileList
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/kafkas_mgmt/v1/supported_sizes"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
