...
*/
func (a *EnterpriseDataplaneClustersApiService) RegisterEnterpriseOsdCluster(ctx _context.Context, enterpriseOsdClusterPayload EnterpriseOsdClusterPayload) (EnterpriseCluster, *_nethttp.Response, error) {
	var (
