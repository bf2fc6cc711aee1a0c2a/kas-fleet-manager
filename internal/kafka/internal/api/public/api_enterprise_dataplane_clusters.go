...
*/
func (a *EnterpriseDataplaneClustersApiService) GetEnterpriseClusterAddonParameters(ctx _context.Context, id string) (EnterpriseClusterAddonParameters, *_nethttp.Response, error) {
	var (
...
*/
func (a *EnterpriseDataplaneClustersApiService) RegisterEnterpriseOsdCluster(ctx _context.Context, enterpriseOsdClusterPayload EnterpriseOsdClusterPayload) (EnterpriseClusterRegistrationResponse, *_nethttp.Response, error) {
	var (
