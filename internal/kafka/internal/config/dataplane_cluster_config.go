...
const (
	defaultObservabilityOperatorIndexImage  = "quay.io/rhoas/observability-operator-index:v4.2.0"
	defaultObservabilityOperatorStartingCSV = "observability-operator.v4.2.0"
)
