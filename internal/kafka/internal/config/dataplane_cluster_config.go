...
const (
	defaultObservabilityOperatorIndexImage  = "quay.io/rhoas/observability-operator-index:v4.1.2"
	defaultObservabilityOperatorStartingCSV = "observability-operator.v4.1.2"
)
