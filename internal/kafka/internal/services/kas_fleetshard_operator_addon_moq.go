...
//             ProvisionFunc: func(cluster api.Cluster) (bool, ParameterList, *errors.ServiceError) {
// 	               panic("mock out the Provision method")
//             },
//             ReconcileParametersFunc: func(cluster api.Cluster) (ParameterList, *errors.ServiceError) {
...
func (mock *KasFleetshardOperatorAddonMock) Provision(cluster api.Cluster) (bool, ParameterList, *errors.ServiceError) {
...
func (mock *KasFleetshardOperatorAddonMock) ReconcileParameters(cluster api.Cluster) (ParameterList, *errors.ServiceError) {
