...
//             },
//             GetAvailableSizesInRegionFunc: func(criteria *FindClusterCriteria) ([]string, *errors.ServiceError) {
...
func (mock *KafkaServiceMock) AssignInstanceType(owner string, organisationID string) (types.KafkaInstanceType, *errors.ServiceError) {
...
func (mock *KafkaServiceMock) DeprovisionExpiredKafkas() *errors.ServiceError {
...
func (mock *KafkaServiceMock) GetAvailableSizesInRegion(criteria *FindClusterCriteria) ([]string, *errors.ServiceError) {
...
func (mock *KafkaServiceMock) GetMarketplaceFromBillingAccountInformation(externalId string, instanceType types.KafkaInstanceType, billingCloudAccountId string, marketplace *string) (string, *errors.ServiceError) {
	if mock.GetMarketplaceFromBillingAccountInformationFunc == nil {
		panic("KafkaServiceMock.GetMarketplaceFromBillingAccountInformationFunc: method is nil but KafkaService.GetMarketplaceFromBillingAccountInformation was just called")
	}
	callInfo := struct {
		ExternalId            string
		InstanceType          types.KafkaInstanceType
...
// Check the length with:
//     len(mockedKafkaService.GetMarketplaceFromBillingAccountInformationCalls())
func (mock *KafkaServiceMock) GetMarketplaceFromBillingAccountInformationCalls() []struct {
	ExternalId            string
	InstanceType          types.KafkaInstanceType
	BillingCloudAccountId string
	Marketplace           *string
