...
//             },
//             VerifyAndUpdateKafkaFunc: func(ctx context.Context, kafkaRequest *dbapi.KafkaRequest) *errors.ServiceError {
...
func (mock *KafkaServiceMock) VerifyAndUpdateKafka(ctx context.Context, kafkaRequest *dbapi.KafkaRequest) *errors.ServiceError {
