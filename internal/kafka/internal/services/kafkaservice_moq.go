...
// 			},
// 			GetMarketplaceFromBillingAccountInformationFunc: func(externalId string, instanceType types.KafkaInstanceType, billingCloudAccountId string, marketplace *string) (string, *serviceError.ServiceError) {
...
func (mock *KafkaServiceMock) GetMarketplaceFromBillingAccountInformation(externalId string, instanceType types.KafkaInstanceType, billingCloudAccountId string, marketplace *string) (string, *serviceError.ServiceError) {
