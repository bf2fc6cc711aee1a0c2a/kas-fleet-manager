...
func (mock *QuotaServiceMock) GetMarketplaceFromBillingAccountInformation(externalId string, instanceType types.KafkaInstanceType, billingCloudAccountId string, marketplace *string) (string, *serviceError.ServiceError) {
