...
func (h kafkaHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	cfg := &handlers.HandlerConfig{
		...
		Action: func() (interface{}, *errors.ServiceError) {
			...
			return presenters.PresentKafkaRequest(convKafka, h.kafkaConfig.BrowserUrl, h.kafkaConfig)
		},
	}
...
func (h kafkaHandler) Get(w http.ResponseWriter, r *http.Request) {
	cfg := &handlers.HandlerConfig{
		Action: func() (i interface{}, serviceError *errors.ServiceError) {
			...
			return presenters.PresentKafkaRequest(kafkaRequest, h.kafkaConfig.BrowserUrl, h.kafkaConfig)
		},
	}
	...
	cfg := &handlers.HandlerConfig{
		Action: func() (interface{}, *errors.ServiceError) {
			...
			for _, kafkaRequest := range kafkaRequests {
				converted, err := presenters.PresentKafkaRequest(kafkaRequest, h.kafkaConfig.BrowserUrl, h.kafkaConfig)
				if err != nil {
