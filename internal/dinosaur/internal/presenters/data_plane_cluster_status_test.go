	...
	tests := []struct {
	...
	}{
		{
			...
			inputClusterUpdateStatusRequest: func() *private.DataPlaneClusterUpdateStatusRequest {
				...
				request.DinosaurOperatorVersions = []string{"v1.0.0-0", "v2.0.0-0", "v3.0.0-0"}
				return request
			},
			want: []api.StrimziVersion{
		...
		},
		{
			...
			inputClusterUpdateStatusRequest: func() *private.DataPlaneClusterUpdateStatusRequest {
				request := sampleValidDataPlaneClusterUpdateStatusRequest()
				request.DinosaurOperatorVersions = []string{"v5.12.0-0", "v5.8.0-0", "v3.0.0-0"}
				return request
			},
			want: []api.StrimziVersion{
				{Version: "v3.0.0-0", Ready: true},
		...
		},
		{
			...
			inputClusterUpdateStatusRequest: func() *private.DataPlaneClusterUpdateStatusRequest {
				request := sampleValidDataPlaneClusterUpdateStatusRequest()
				request.DinosaurOperatorVersions = []string{}
				return request
			},
			want:    []api.StrimziVersion{},
			wantErr: false,
		},
		{
			...
			inputClusterUpdateStatusRequest: func() *private.DataPlaneClusterUpdateStatusRequest {
				request := sampleValidDataPlaneClusterUpdateStatusRequest()
				request.DinosaurOperatorVersions = nil
				return request
			},
			want:    []api.StrimziVersion{},
			wantErr: false,
		},
		{
			...
			inputClusterUpdateStatusRequest: func() *private.DataPlaneClusterUpdateStatusRequest {
				request := sampleValidDataPlaneClusterUpdateStatusRequest()
				request.DinosaurOperator = []private.DataPlaneClusterUpdateStatusRequestDinosaurOperator{
					{Version: "v1.0.0-0", Ready: true},
		...
		},
		{
			...
			inputClusterUpdateStatusRequest: func() *private.DataPlaneClusterUpdateStatusRequest {
				...
				request.DinosaurOperatorVersions = []string{"v18.0.0-0", "v15.0.0-0", "v16.0.0-0"}
				return request
			},
			want: []api.StrimziVersion{
				{Version: "v2.0.0-0", Ready: false},
		...
		},
		{
			...
			inputClusterUpdateStatusRequest: func() *private.DataPlaneClusterUpdateStatusRequest {
				request := sampleValidDataPlaneClusterUpdateStatusRequest()
				request.DinosaurOperatorVersions = []string{"v1invalid.0.0-0", "v2.0.0-0", "v3.0.0-0"}
				return request
			},
			want:    nil,
			wantErr: true,
