...
var migrations = []*gormigrate.Migration{
	addDinosaurRequest(),
	addClusters(),
	updateDinosaurMultiAZTypeToBoolean(),
	addDinosaurbootstrapServerHostType(),
	addClusterStatus(),
	addDinosaurOrganisationId(),
	addLeaderLease(),
	addFailedReason(),
	addConnectors(),
	addDinosaurPlacementId(),
	addConnectorClusters(),
	addDinosaurSubscriptionId(),
	addClusterIdentityProviderID(),
	addDinosaurSsoClientIdAndSecret(),
	addDinosaurOwnerAccountId(),
	addDinosaurVersion(),
	connectorApiChanges(),
	addMissingIndexes(),
	addClusterStatusIndex(),
	addDinosaurWorkersInLeaderLeases(),
	renameDeletingDinosaurLeaseType(),
	addClusterDNS(),
	connectorMigrations20210518(),
	addExternalIDsToSpecificClusters(),
	addDinosaurConnectionSettingsToConnectors(),
	addClusterProviderInfo(),
	changeDinosaurDeleteStatusToDeleting(),
	addDinosaurQuotaTypeColumn(),
	addConnectorTypeChannel(),
	addRoutes(),
	addDinosaurDNSWorkerLease(),
	addClusterAvailableStrimziVersions(),
	addDinosaurUpgradeFunctionalityRelatedFields(),
	renameDinosaurVersionField(),
	updateDesiredStrimziVersions(),
	addDinosaurInstanceTypeColumn(),
	addDinosaurCanaryServiceAccountColumns(),
	addDinosaurNamespaceColumn(),
	migrateOldDinosaurNamespace(),
	migrateOldDinosaurNamespaceCreatedDuringDeployment(),
	...
	addDinosaurFailedWorkerLease(),
	resetCanaryServiceAccountForAffectedInstances(),
	addClusterSupportedInstanceType(),
	addDinosaurReauthenticationEnabledColumn(),
	addDinosaurIBPVersionRelatedFields(),
	addDinosaurRoutesCreationIdColumn(),
}
