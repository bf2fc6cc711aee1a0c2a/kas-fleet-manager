...
type Dinosaur struct {
	...
	DesiredDinosaurIbpVersion string                `json:"desired_dinosaur_ibp_version,omitempty"`
	ActualDinosaurIbpVersion  string                `json:"actual_dinosaur_ibp_version,omitempty"`
