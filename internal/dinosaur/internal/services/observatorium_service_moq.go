...
//             },
//             GetMetricsByDinosaurIdFunc: func(ctx context.Context, csMetrics *observatorium.DinosaurMetrics, id string, query observatorium.MetricsReqParams) (string, *svcerrs.ServiceError) {
...
type ObservatoriumServiceMock struct {
	...
	GetMetricsByDinosaurIdFunc func(ctx context.Context, csMetrics *observatorium.DinosaurMetrics, id string, query observatorium.MetricsReqParams) (string, *errors.ServiceError)
...
func (mock *ObservatoriumServiceMock) GetMetricsByDinosaurId(ctx context.Context, csMetrics *observatorium.DinosaurMetrics, id string, query observatorium.MetricsReqParams) (string, *errors.ServiceError) {
