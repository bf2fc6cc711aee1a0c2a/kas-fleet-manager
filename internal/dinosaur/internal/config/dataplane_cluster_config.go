...
func (c *DataplaneClusterConfig) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&c.StrimziOperatorVersion, "strimzi-operator-version", c.StrimziOperatorVersion, "The version of the Strimzi operator to install. If set, DesiredStrimziVersion in dinosaur_request will updated with this value. Otherwise value reported from kas-fleetshard operator will be used")
