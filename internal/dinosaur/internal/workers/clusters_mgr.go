...
import (
	...
	dinosaurConstants "github.com/bf2fc6cc711aee1a0c2a/kas-fleet-manager/internal/dinosaur/constants"
...
func (c *ClusterManager) reconcileClusterResources(cluster api.Cluster) error {
	...
	clusterDNS = strings.Replace(clusterDNS, dinosaurConstants.DefaultIngressDnsNamePrefix, dinosaurConstants.ManagedDinosaurIngressDnsNamePrefix, 1)
