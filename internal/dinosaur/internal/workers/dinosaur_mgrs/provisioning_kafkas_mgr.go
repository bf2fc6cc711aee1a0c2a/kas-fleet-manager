...
func (k *ProvisioningDinosaurManager) Reconcile() []error {
	...
	// Dinosaurs in a "provisioning" state means that it is ready to be sent to the KAS Fleetshard Operator for Dinosaur creation in the data plane cluster.
	// The update of the Dinosaur request status from 'provisioning' to another state will be handled by the KAS Fleetshard Operator.
