...
func connector_mgmtYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "connector_mgmt.yaml", size: 52549, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
