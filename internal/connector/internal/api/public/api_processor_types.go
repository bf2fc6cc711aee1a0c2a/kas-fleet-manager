...
// ProcessorTypesApiService ProcessorTypesApi service
type ProcessorTypesApiService service

/*
GetProcessorTypeByID Get a processor type by id
Get a processor type by id
  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param processorTypeId The id of the processor type

@return ProcessorType
*/
func (a *ProcessorTypesApiService) GetProcessorTypeByID(ctx _context.Context, processorTypeId string) (ProcessorType, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  ProcessorType
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v2alpha1/processor_types/{processor_type_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"processor_type_id"+"}", _neturl.QueryEscape(parameterToString(processorTypeId, "")), -1)
...
// GetProcessorTypesOpts Optional parameters for the method 'GetProcessorTypes'
type GetProcessorTypesOpts struct {
...
/*
GetProcessorTypes Returns a list of processor types
Returns a list of processor types
  - @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param optional nil or *GetProcessorTypesOpts - Optional Parameters:
...
*/
func (a *ProcessorTypesApiService) GetProcessorTypes(ctx _context.Context, localVarOptionals *GetProcessorTypesOpts) (ProcessorTypeList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ProcessorTypeList
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v2alpha1/processor_types"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
