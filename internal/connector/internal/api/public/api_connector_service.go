...
/*
GetServiceStatus Returns the status of resources
Returns the status of resources
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return ServiceStatus
*/
func (a *ConnectorServiceApiService) GetServiceStatus(ctx _context.Context) (ServiceStatus, *_nethttp.Response, error) {
	var (
