...
*/
func (a *ConnectorTypesApiService) GetConnectorTypeLabels(ctx _context.Context, localVarOptionals *GetConnectorTypeLabelsOpts) (ConnectorTypeLabelCountList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/kafka_connector_types/labels"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
