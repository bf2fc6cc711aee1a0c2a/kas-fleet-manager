...
func (a *ConnectorClustersAgentApiService) GetClusterAsignedConnectorDeploymentById(ctx _context.Context, connectorClusterId string, deploymentId string) (ConnectorDeployment, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/dinosaur_connector_clusters/{connector_cluster_id}/deployments/{deployment_id}"
...
func (a *ConnectorClustersAgentApiService) GetClusterAsignedConnectorDeployments(ctx _context.Context, connectorClusterId string, localVarOptionals *GetClusterAsignedConnectorDeploymentsOpts) (ConnectorDeploymentList, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/dinosaur_connector_clusters/{connector_cluster_id}/deployments"
	localVarPath = strings.Replace(localVarPath, "{"+"connector_cluster_id"+"}", _neturl.QueryEscape(parameterToString(connectorClusterId, "")), -1)
...
func (a *ConnectorClustersAgentApiService) UpdateConnectorDeploymentStatus(ctx _context.Context, connectorClusterId string, deploymentId string, connectorDeploymentStatus ConnectorDeploymentStatus) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/dinosaur_connector_clusters/{connector_cluster_id}/deployments/{deployment_id}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"connector_cluster_id"+"}", _neturl.QueryEscape(parameterToString(connectorClusterId, "")), -1)
...
/*
UpdateDinosaurConnectorClusterStatus Update the status of a connector cluster
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param connectorClusterId The id of the connector cluster
 * @param connectorClusterStatus Cluster status update data
*/
func (a *ConnectorClustersAgentApiService) UpdateDinosaurConnectorClusterStatus(ctx _context.Context, connectorClusterId string, connectorClusterStatus ConnectorClusterStatus) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/dinosaur_connector_clusters/{connector_cluster_id}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"connector_cluster_id"+"}", _neturl.QueryEscape(parameterToString(connectorClusterId, "")), -1)
