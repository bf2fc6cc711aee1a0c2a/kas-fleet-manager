...
func (a *ConnectorClustersAgentApiService) GetClusterAssignedProcessorDeploymentById(ctx _context.Context, connectorClusterId string, processorDeploymentId string) (ProcessorDeployment, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v2alpha1/agent/kafka_connector_clusters/{connector_cluster_id}/processors/deployments/{processor_deployment_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"connector_cluster_id"+"}", _neturl.QueryEscape(parameterToString(connectorClusterId, "")), -1)
