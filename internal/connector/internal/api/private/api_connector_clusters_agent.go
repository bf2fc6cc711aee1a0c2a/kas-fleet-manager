...
func (a *ConnectorClustersAgentApiService) GetClusterAsignedConnectorDeploymentById(ctx _context.Context, connectorClusterId string, deploymentId string) (ConnectorDeployment, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/kafka_connector_clusters/{connector_cluster_id}/deployments/{deployment_id}"
...
func (a *ConnectorClustersAgentApiService) GetClusterAsignedConnectorDeployments(ctx _context.Context, connectorClusterId string, localVarOptionals *GetClusterAsignedConnectorDeploymentsOpts) (ConnectorDeploymentList, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/kafka_connector_clusters/{connector_cluster_id}/deployments"
	localVarPath = strings.Replace(localVarPath, "{"+"connector_cluster_id"+"}", _neturl.QueryEscape(parameterToString(connectorClusterId, "")), -1)
...
func (a *ConnectorClustersAgentApiService) GetClusterAsignedConnectorNamespaceById(ctx _context.Context, connectorClusterId string, namespaceId string) (ConnectorNamespace, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/kafka_connector_clusters/{connector_cluster_id}/agent_namespaces/{namespace_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"connector_cluster_id"+"}", _neturl.QueryEscape(parameterToString(connectorClusterId, "")), -1)
...
func (a *ConnectorClustersAgentApiService) GetClusterAsignedConnectorNamespaces(ctx _context.Context, connectorClusterId string) (ConnectorNamespaceList, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/kafka_connector_clusters/{connector_cluster_id}/agent_namespaces"
	localVarPath = strings.Replace(localVarPath, "{"+"connector_cluster_id"+"}", _neturl.QueryEscape(parameterToString(connectorClusterId, "")), -1)
...
func (a *ConnectorClustersAgentApiService) UpdateConnectorDeploymentStatus(ctx _context.Context, connectorClusterId string, deploymentId string, connectorDeploymentStatus ConnectorDeploymentStatus) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/kafka_connector_clusters/{connector_cluster_id}/deployments/{deployment_id}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"connector_cluster_id"+"}", _neturl.QueryEscape(parameterToString(connectorClusterId, "")), -1)
...
func (a *ConnectorClustersAgentApiService) UpdateKafkaConnectorClusterStatus(ctx _context.Context, connectorClusterId string, connectorClusterStatus ConnectorClusterStatus) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/kafka_connector_clusters/{connector_cluster_id}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"connector_cluster_id"+"}", _neturl.QueryEscape(parameterToString(connectorClusterId, "")), -1)
