...
const (
	...
	AssignProcessor   ProcessorOperation = "assign"
	UnassignProcessor ProcessorOperation = "unassign"
...
// ProcessorFSM handles processor phase changes within its cluster's current phase
...
var processorEvents = map[dbapi.ConnectorNamespacePhaseEnum][]fsm.EventDesc{
	dbapi.ConnectorNamespacePhaseDisconnected: {
		{Name: string(CreateProcessor), Src: []string{string(dbapi.ProcessorUnassigned), string(dbapi.ProcessorReady)}, Dst: string(dbapi.ProcessorReady)},
		{Name: string(AssignProcessor), Src: []string{string(dbapi.ProcessorUnassigned), string(dbapi.ProcessorReady)}, Dst: string(dbapi.ProcessorReady)},
		{Name: string(UnassignProcessor), Src: []string{string(dbapi.ProcessorUnassigned), string(dbapi.ProcessorReady), string(dbapi.ProcessorStopped)}, Dst: string(dbapi.ProcessorUnassigned)},
		{Name: string(UpdateProcessor), Src: []string{string(dbapi.ProcessorUnassigned)}, Dst: string(dbapi.ProcessorUnassigned)},
		...
		{Name: string(StopProcessor), Src: []string{string(dbapi.ProcessorStopped), string(dbapi.ProcessorReady)}, Dst: string(dbapi.ProcessorStopped)},
		{Name: string(DeleteProcessor), Src: []string{string(dbapi.ProcessorUnassigned), string(dbapi.ProcessorReady), string(dbapi.ProcessorStopped), string(dbapi.ProcessorDeleted)}, Dst: string(dbapi.ProcessorDeleted)},
	},
	dbapi.ConnectorNamespacePhaseReady: {
		{Name: string(CreateProcessor), Src: []string{string(dbapi.ProcessorUnassigned), string(dbapi.ProcessorReady)}, Dst: string(dbapi.ProcessorReady)},
		{Name: string(AssignProcessor), Src: []string{string(dbapi.ProcessorUnassigned)}, Dst: string(dbapi.ProcessorReady)},
		{Name: string(UnassignProcessor), Src: []string{string(dbapi.ProcessorUnassigned), string(dbapi.ProcessorReady), string(dbapi.ProcessorStopped)}, Dst: string(dbapi.ProcessorUnassigned)},
		{Name: string(UpdateProcessor), Src: []string{string(dbapi.ProcessorUnassigned)}, Dst: string(dbapi.ProcessorUnassigned)},
		{Name: string(UpdateProcessor), Src: []string{string(dbapi.ProcessorReady)}, Dst: string(dbapi.ProcessorReady)},
		{Name: string(UpdateProcessor), Src: []string{string(dbapi.ProcessorStopped)}, Dst: string(dbapi.ProcessorStopped)},
		{Name: string(RestartProcessor), Src: []string{string(dbapi.ProcessorStopped), string(dbapi.ProcessorReady)}, Dst: string(dbapi.ProcessorReady)},
		{Name: string(StopProcessor), Src: []string{string(dbapi.ProcessorStopped), string(dbapi.ProcessorReady)}, Dst: string(dbapi.ProcessorStopped)},
		{Name: string(DeleteProcessor), Src: []string{string(dbapi.ProcessorUnassigned), string(dbapi.ProcessorReady), string(dbapi.ProcessorStopped), string(dbapi.ProcessorDeleted)}, Dst: string(dbapi.ConnectorDeleted)},
	},
...
var ProcessorStartingPhase = map[ProcessorOperation]dbapi.ProcessorStatusPhase{
	CreateProcessor:   dbapi.ProcessorStatusPhaseAssigning,
	AssignProcessor:   dbapi.ProcessorStatusPhaseAssigning,
	UnassignProcessor: dbapi.ProcessorStatusPhaseDeleting,
	RestartProcessor:  dbapi.ProcessorStatusPhaseAssigned,
	StopProcessor:     dbapi.ProcessorStatusPhaseAssigned,
