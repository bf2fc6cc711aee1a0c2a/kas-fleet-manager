...
5. Each call to OCM endpoints needs specific permisions. Make sure that you have all the needed permission to call OCM endpoints. If the role created in step (2) is missing those permissions, then they can be added via the [account-manager repo](https://gitlab.cee.redhat.com/service/uhc-account-manager). See an example [MR](https://gitlab.cee.redhat.com/service/uhc-account-manager/-/merge_requests/2530). 
