Feature: create a a connector
  ...
  but Coworker Sally can.
    ...
    When I DELETE path "/v1/kafka-connectors/${connector_id}"
    Then the response code should be 204
    And the response should match ""

    Given I wait up to "5" seconds for a GET on path "/v1/kafka-connectors/${connector_id}" response code to match "404"
    When I GET path "/v1/kafka-connectors/${connector_id}"
    Then the response code should be 404
