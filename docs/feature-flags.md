...
- **strimzi-operator-version** The version of the Strimzi operator to install. If set, DesiredStrimziVersion in dinosaur_request will be updated with this value. Otherwise value reported from kas-fleetshard operator will be used
