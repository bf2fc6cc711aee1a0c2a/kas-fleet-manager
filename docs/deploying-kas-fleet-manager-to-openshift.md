...
- `DYNAMIC_SCALING_CONFIG`: The configuration file that contains information about each Kafka instance types, dynamic scaling configuration. Defaults to `"{developer: {reserved_streaming_units: 3, compute_nodes_config: {max_compute_nodes: 3}}, standard: {reserved_streaming_units: 10, compute_nodes_config: {max_compute_nodes: 9}}}"`
