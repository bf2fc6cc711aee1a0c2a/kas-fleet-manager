...
- `OBSERVABILITY_OPERATOR_INDEX_IMAGE`: Observability Operator index image. Defaults to `quay.io/rhoas/observability-operator-index:v3.0.15`.
...
- `OBSERVABILITY_OPERATOR_STARTING_CSV`: Observability Operator starting CSV. Defaults to `observability-operator.v3.0.15`.
...
- `DYNAMIC_SCALING_CONFIG`: The configuration file that contains information about each Kafka instance types, dynamic scaling configuration. Defaults to `"{new_data_plane_openshift_version: '', enable_dynamic_data_plane_scale_down: false, enable_dynamic_data_plane_scale_up: false, compute_nodes_per_instance_type: {developer: {compute_nodes_config: {max_compute_nodes: 3}}, standard: {compute_nodes_config: {max_compute_nodes: 9}}}, machine_type_per_cloud_provider: {gcp: {cluster_wide_workload_machine_type: custom-8-32768, kafka_workload_machine_type: custom-8-32768}, aws: {cluster_wide_workload_machine_type: m5.2xlarge, kafka_workload_machine_type: r5.xlarge}}}"`
