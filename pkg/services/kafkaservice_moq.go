...
// 			},
// 			GetByClusterIDFunc: func(clusterID string) (api.KafkaList, *apiErrors.ServiceError) {
...
func (mock *KafkaServiceMock) GetByClusterID(clusterID string) (api.KafkaList, *apiErrors.ServiceError) {
