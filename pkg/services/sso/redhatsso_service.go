...
func (r *redhatssoService) CreateServiceAccountInternal(accessToken string, request services.CompleteServiceAccountRequest) (*api.ServiceAccount, *errors.ServiceError) {
	return nil, nil
}
