...
// 			},
// 			HasAssignedQuotaFunc: func(organizationId string, quotaType DinosaurQuotaType) (bool, error) {
...
func (mock *ClientMock) HasAssignedQuota(organizationId string, quotaType DinosaurQuotaType) (bool, error) {
