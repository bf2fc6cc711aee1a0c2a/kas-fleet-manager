...
func (a *ConnectorsApiService) CreateConnector(ctx _context.Context, async bool, connector Connector) (Connector, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/kafka-connectors"
...
func (a *ConnectorsApiService) DeleteConnector(ctx _context.Context, connectorId string, localVarOptionals *DeleteConnectorOpts) (Error, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/kafkas-connectors/{connector_id}"
