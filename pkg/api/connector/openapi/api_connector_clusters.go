...
func (a *ConnectorClustersApiService) CreateConnectorCluster(ctx _context.Context, async bool, connectorCluster ConnectorCluster) (ConnectorCluster, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/kafka-connector-clusters"
...
func (a *ConnectorClustersApiService) DeleteConnectorCluster(ctx _context.Context, connectorClusterId string) (Error, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/kafka-connector-clusters/{connector_cluster_id}"
...
func (a *ConnectorClustersApiService) GetConnectorClusterAddonParameters(ctx _context.Context, connectorClusterId string) ([]AddonParameter, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/connector_mgmt/v1/kafka-connector-clusters/{connector_cluster_id}/addon-parameters"
	localVarPath = strings.Replace(localVarPath, "{"+"connector_cluster_id"+"}", _neturl.QueryEscape(parameterToString(connectorClusterId, "")), -1)
