...
@return Connector
*/
func (a *ConnectorsApiService) CreateConnector(ctx _context.Context, async bool, connector Connector, localVarOptionals *CreateConnectorOpts) (Connector, *_nethttp.Response, error) {
	var (
