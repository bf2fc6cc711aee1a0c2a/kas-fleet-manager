...
func (a *ConnectorTypesApiService) GetConnectorTypeByID(ctx _context.Context, connectorTypeId string) (ConnectorType, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/api/kafkas_mgmt/v1/kafka-connector-types/{connector_type_id}"
...
func (a *ConnectorTypesApiService) ListConnectorTypes(ctx _context.Context, localVarOptionals *ListConnectorTypesOpts) (ConnectorTypeList, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/kafkas_mgmt/v1/kafka-connector-types"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
