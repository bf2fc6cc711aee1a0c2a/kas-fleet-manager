...
// GetMetricsByKafkaIdOpts Optional parameters for the method 'GetMetricsByKafkaId'
type GetMetricsByKafkaIdOpts struct {
 ...
 * @param optional nil or *GetMetricsByKafkaIdOpts - Optional Parameters:
...
@return MetricsList
*/
func (a *DefaultApiService) GetMetricsByKafkaId(ctx _context.Context, id string, duration int64, interval int64, localVarOptionals *GetMetricsByKafkaIdOpts) (MetricsList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/managed-services-api/v1/kafkas/{id}/metrics"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.QueryEscape(parameterToString(id, "")), -1)
...
@return ServiceAccount
*/
func (a *DefaultApiService) GetServiceAccountById(ctx _context.Context, id string) (ServiceAccount, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
