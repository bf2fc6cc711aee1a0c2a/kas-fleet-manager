 ...
 **search** | **optional.String**| Search criteria.  The syntax of this parameter is similar to the syntax of the _where_ clause of an SQL statement. Allowed fields in the search are: region, cloud_provider, multi_az, name, status. For example, in order to retrieve all kafka requests with a name starting with &#x60;my&#x60; the value should be:  &#x60;&#x60;&#x60; name like &#39;my%&#39; &#x60;&#x60;&#x60;  To retrieve all kafka requests with a name starting with &#x60;my&#x60; and region equal &#x60;aws&#x60;, the value should be:  &#x60;&#x60;&#x60; name like &#39;my%&#39; and cloud_provider &#x3D; aws &#x60;&#x60;&#x60;  If the parameter isn&#39;t provided, or if the value is empty, then all the kafkas that the user has permission to see will be returned. Note. If the query is invalid, an error will be returned  | 
